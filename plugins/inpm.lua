...
local function run(msg, matches)
   ...
   if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
      ...
      text = "Welcome to Double 21!\n\nTo get a list of Double 21 groups use /chats or /chatlist for a document list of chats.\n\nTo get a new Double 21 group, contact my sudo @OcTaVeWw\n\nThanks for using @Double2121!"
      return text
   end

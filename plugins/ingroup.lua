...
local funcation lock_chat(msg, data, target)
if not is_momod(msg) then
   return "For mods only!"
 else
 data[toristing(target)]['settings']['lock_chat'] = 'no'
end

local funcation lock_username(msg, data, target)
 if not is_momod(msg) then
   return "For mods only!"
  else
  data[toristing(target)]['settings']['lock_username']
 end
